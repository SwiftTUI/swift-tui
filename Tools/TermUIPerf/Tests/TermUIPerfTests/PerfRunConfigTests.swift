...
struct PerfRunConfigTests {
  ...
  func runCommandRejectsUnknownScenarioWithKnownNames() throws {
    ...
    #expect(
      error?.description
        == "unknown scenario 'missing-scenario'. Known scenarios: example-app-shell-workflow, gallery-animation-click, layout-scroll-burst, sheet-open-latency, synthetic-continuous-animation, synthetic-narrow-invalidation, synthetic-offscreen-phase-animator, synthetic-text-shimmer."
    )
  }
