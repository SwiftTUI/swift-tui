...
//  file, You can obtain one at https://mozilla.org/MPL/2.0/.
    ...
    // WASI supports the platform-independent PNG.BytestreamSource and
    // PNG.BytestreamDestination APIs. The System.File convenience layer below
    // intentionally remains disabled because WASI libc does not expose FILE.
    import WASILibc
#elseif os(Windows)
