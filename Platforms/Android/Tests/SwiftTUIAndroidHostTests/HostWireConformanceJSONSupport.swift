  ...
  indirect enum HostWireConformanceJSON: Equatable {
    ...
    private static func convert(
      ...
      if let number = value as? NSNumber {
        ...
        #else
          // Windows exposes no CoreFoundation module; objCType is the
          // remaining bool-vs-number discriminator ("c" — signed char — is
          // how a boolean NSNumber encodes).
          if unsafe String(cString: number.objCType) == "c" {
            return .bool(number.boolValue)
          }
        #endif
