...
- `terminal-workspace`: a Zellij-style workspace example with tabs, split panes, retained terminal sessions, command palette actions, and persisted layout metadata
