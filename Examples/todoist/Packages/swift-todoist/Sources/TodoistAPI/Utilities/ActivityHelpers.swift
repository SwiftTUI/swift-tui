public enum ActivityHelpers {
  ...
  public static func normalizeObjectEventTypeForAPI(_ value: String) -> String {
    ...
    return
      "\(normalizeObjectTypeForAPI(String(pieces[0])) ?? String(pieces[0])):\(pieces.dropFirst().joined())"
  }
  ...
  public static func denormalizeObjectEventTypeFromAPI(_ value: String) -> String {
    ...
    return
      "\(denormalizeObjectTypeFromAPI(String(pieces[0])) ?? String(pieces[0])):\(pieces.dropFirst().joined())"
  }
}
