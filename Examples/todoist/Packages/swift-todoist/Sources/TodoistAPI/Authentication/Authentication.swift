...
public func getAuthToken(_ args: AuthTokenRequest, options: AuthOptions? = nil) async throws
  -> AuthTokenResponse
{
...
public func revokeToken(_ args: RevokeTokenRequest, options: AuthOptions? = nil) async throws
  -> Bool
{
  let transport = options?.customTransport ?? DefaultTodoistTransport()
