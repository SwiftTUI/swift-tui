...
public struct CommentQuery: Sendable {
  ...
  public init(
    taskId: String? = nil, projectId: String? = nil, cursor: String? = nil, limit: Int? = nil
  ) {
    self.taskId = taskId
    self.projectId = projectId
    self.cursor = cursor
...
public struct CommentAttachmentInput: Sendable {
  ...
  public init(
    fileName: String? = nil, fileUrl: String, fileType: String? = nil, resourceType: String? = nil
  ) {
...
public struct LocationReminderUpdateRequest: Sendable {
  ...
  fileprivate var hasMutableFields: Bool {
    notifyUid != nil || name != nil || locLat != nil || locLong != nil || locTrigger != nil
      || radius != nil
  }
}
...
public final class TodoistClient: Sendable {
  ...
  public struct TasksService: Sendable {
    ...
    public func quickAdd(_ request: QuickAddTaskRequest) async throws -> Task {
      var payload: [String: Any] = [
        "text": UncompletableHelpers.processTaskContent(
          request.text, isUncompletable: request.isUncompletable)
      ]
    ...
    public func update(_ id: String, _ request: TaskUpdateRequest, requestId: String? = nil)
      async throws -> Task
    {
      try request.validate()
      return try await configuration.request(
    ...
    public func move(_ id: String, to destination: TaskMoveDestination, requestId: String? = nil)
      async throws -> Task
    {
      try await configuration.request(
        Task.self,
    ...
    public func move(_ ids: [String], to destination: TaskMoveDestination, requestId: String? = nil)
      async throws -> [Task]
    {
      guard ids.count <= MAX_COMMAND_COUNT else {
        throw TodoistRequestError(
          "Maximum number of items is \(MAX_COMMAND_COUNT)", httpStatusCode: 400)
      }
  ...
  public struct ProjectsService: Sendable {
    ...
    public func get(_ id: String) async throws -> Project {
      try await configuration.request(
        Project.self, method: .get, path: TodoistClientSupport.path(ENDPOINT_REST_PROJECTS, id))
    }
    ...
    public func create(_ request: ProjectCreateRequest, requestId: String? = nil) async throws
      -> Project
    {
      try await configuration.request(
        Project.self,
    ...
    public func update(_ id: String, _ request: ProjectUpdateRequest, requestId: String? = nil)
  ...
  public struct SectionsService: Sendable {
    ...
    public func get(_ id: String) async throws -> Section {
      try await configuration.request(
        Section.self, method: .get, path: TodoistClientSupport.path(ENDPOINT_REST_SECTIONS, id))
    }

    public func list(projectId: String? = nil, cursor: String? = nil, limit: Int? = nil)
      async throws -> TodoistPage<Section>
    {
      try await configuration.request(
        TodoistPage<Section>.self,
        method: .get,
        path: ENDPOINT_REST_SECTIONS,
        payload: ["projectId": projectId as Any, "cursor": cursor as Any, "limit": limit as Any]
          .compactMapValues { $0 },
      )
    }

    public func create(_ request: SectionCreateRequest, requestId: String? = nil) async throws
      -> Section
    {
      try await configuration.request(
        Section.self,
    ...
    public func update(_ id: String, _ request: SectionUpdateRequest, requestId: String? = nil)
  ...
  public struct LabelsService: Sendable {
    ...
    public func get(_ id: String) async throws -> Label {
      try await configuration.request(
        Label.self, method: .get, path: TodoistClientSupport.path(ENDPOINT_REST_LABELS, id))
    }
    ...
    public func create(_ request: LabelCreateRequest, requestId: String? = nil) async throws
      -> Label
    {
      try await configuration.request(
        Label.self,
    ...
    public func update(_ id: String, _ request: LabelUpdateRequest, requestId: String? = nil)
      async throws -> Label
    {
      try await configuration.request(
        Label.self,
  ...
  public struct CommentsService: Sendable {
    ...
    public func get(_ id: String) async throws -> Comment {
      try await configuration.request(
        Comment.self, method: .get, path: TodoistClientSupport.path(ENDPOINT_REST_COMMENTS, id))
    }
    ...
    public func create(_ request: CommentCreateRequest, requestId: String? = nil) async throws
      -> Comment
    {
    ...
    public func update(_ id: String, _ request: CommentUpdateRequest, requestId: String? = nil)
  ...
  public struct RemindersService: Sendable {
    ...
    public func list(_ query: ReminderQuery = .init()) async throws -> TodoistPage<Reminder> {
      try await configuration.request(
        ...
        payload: [
          "taskId": query.taskId as Any, "cursor": query.cursor as Any, "limit": query.limit as Any,
        ].compactMapValues { $0 },
      )
    }
    ...
    public func create(_ request: RelativeReminderCreateRequest, requestId: String? = nil)
    ...
    public func create(_ request: AbsoluteReminderCreateRequest, requestId: String? = nil)
      async throws -> Reminder
    {
      try await configuration.request(
        Reminder.self,
    ...
    public func createLocation(_ request: LocationReminderCreateRequest, requestId: String? = nil)
      async throws -> Reminder
    {
      try await configuration.request(
        Reminder.self,
    ...
    public func update(
      _ id: String, _ request: RelativeReminderUpdateRequest, requestId: String? = nil
    ) async throws -> Reminder {
    ...
    public func update(
      _ id: String, _ request: AbsoluteReminderUpdateRequest, requestId: String? = nil
    ) async throws -> Reminder {
      guard request.hasMutableFields else {
        throw TodoistArgumentError("At least one reminder field must be provided to updateReminder")
      }
    ...
    public func updateLocation(
      _ id: String, _ request: LocationReminderUpdateRequest, requestId: String? = nil
    ) async throws -> Reminder {
      guard request.hasMutableFields else {
        throw TodoistArgumentError(
  ...
  public struct UploadsService: Sendable {
    ...
    public func upload(_ request: UploadRequest, requestId: String? = nil) async throws
      -> Attachment
    {
    ...
    public func viewAttachment(url: String) async throws -> TodoistFileResponse {
      ...
      guard (200..<300).contains(response.statusCode) else {
        throw TodoistArgumentError(
          "Failed to fetch attachment: \(response.statusCode) \(response.statusText)")
      }
  ...
  public struct BackupsService: Sendable {
    ...
    public func download(file: String) async throws -> TodoistFileResponse {
      var components = URLComponents(
        url: try configuration.buildURL(for: ENDPOINT_REST_BACKUPS_DOWNLOAD),
  ...
  public struct TemplatesService: Sendable {
    ...
    public func exportAsFile(projectId: String, useRelativeDates: Bool? = nil) async throws
      -> String
    {
      let response = try await configuration.requestRaw(
        method: .get,
        path: ENDPOINT_REST_TEMPLATES_FILE,
        payload: ["projectId": projectId, "useRelativeDates": useRelativeDates as Any]
          .compactMapValues { $0 },
      )
    ...
    public func exportAsURL(projectId: String, useRelativeDates: Bool? = nil) async throws
  ...
  public struct WorkspacesService: Sendable {
    ...
    public func list(requestId: String? = nil) async throws -> [Workspace] {
      try await configuration.request(
        [Workspace].self, method: .get, path: ENDPOINT_WORKSPACES, requestId: requestId)
    }

    public func get(_ id: String, requestId: String? = nil) async throws -> Workspace {
      try await configuration.request(
        Workspace.self, method: .get, path: TodoistClientSupport.path(ENDPOINT_WORKSPACES, id),
        requestId: requestId)
    }

    public func create(_ request: WorkspaceCreateRequest, requestId: String? = nil) async throws
      -> Workspace
    {
      try await configuration.request(
        Workspace.self,
    ...
    public func update(_ id: String, _ request: WorkspaceUpdateRequest, requestId: String? = nil)
  ...
  public struct SyncService: Sendable {
    ...
    public func execute(_ request: SyncRequest, requestId: String? = nil) async throws
      -> SyncResponse
    {
...
extension TaskUpdateRequest {
  ...
  public func payload() -> [String: Any] {
    ...
    if let content {
      payload["content"] = UncompletableHelpers.processTaskContent(
        content, isUncompletable: isUncompletable)
    }
    if let description { payload["description"] = description }
    if let labels { payload["labels"] = labels }
    if let priority { payload["priority"] = priority }
...
extension ProjectCreateRequest {
  public func payload() -> [String: Any] {
...
extension ProjectUpdateRequest {
  public func payload() -> [String: Any] {
    var payload: [String: Any] = [:]
...
extension SectionCreateRequest {
  public func payload() -> [String: Any] {
...
extension SectionUpdateRequest {
  public func payload() -> [String: Any] {
    ["name": name]
  }
}

extension LabelCreateRequest {
  public func payload() -> [String: Any] {
    var payload: [String: Any] = ["name": name]
    if let order { payload["order"] = order }
    if let color { payload["color"] = color }
...
extension CommentCreateRequest {
  public func payload() -> [String: Any] {
...
extension CommentUpdateRequest {
  public func payload() -> [String: Any] {
    ["content": content]
  }
}

extension RelativeReminderCreateRequest {
  public func payload() -> [String: Any] {
    var payload: [String: Any] = [
      "taskId": taskId,
...
extension AbsoluteReminderCreateRequest {
  public func payload() -> [String: Any] {
    var payload: [String: Any] = [
      "taskId": taskId,
...
extension LocationReminderCreateRequest {
  public func payload() -> [String: Any] {
    var payload: [String: Any] = [
      "taskId": taskId,
...
extension RelativeReminderUpdateRequest {
  public func payload() -> [String: Any] {
...
extension AbsoluteReminderUpdateRequest {
  public func payload() -> [String: Any] {
...
extension LocationReminderUpdateRequest {
  public func payload() -> [String: Any] {
    var payload: [String: Any] = [:]
    if let notifyUid { payload["notifyUid"] = notifyUid }
    if let name { payload["name"] = name }
...
extension WorkspaceCreateRequest {
  public func payload() -> [String: Any] {
    var payload: [String: Any] = ["name": name]
    if let description { payload["description"] = description }
...
extension WorkspaceUpdateRequest {
  public func payload() -> [String: Any] {
    var payload: [String: Any] = [:]
    if let name { payload["name"] = name }
    if let isLinkSharingEnabled { payload["isLinkSharingEnabled"] = isLinkSharingEnabled }
...
extension TodoistClient {
  ...
  public func getTasks(_ query: TaskQuery = .init()) async throws -> TodoistPage<Task> {
    try await tasks.list(query)
  }

  @available(*, deprecated, message: "Use tasks.create(_:requestId:)")
  public func addTask(_ request: TaskCreateRequest, requestId: String? = nil) async throws -> Task {
    try await tasks.create(request, requestId: requestId)
  }

  @available(*, deprecated, message: "Use tasks.quickAdd(_:)")
  public func quickAddTask(_ request: QuickAddTaskRequest) async throws -> Task {
    try await tasks.quickAdd(request)
  }

  @available(*, deprecated, message: "Use tasks.update(_:_:requestId:)")
  public func updateTask(_ id: String, _ request: TaskUpdateRequest, requestId: String? = nil)
    async throws -> Task
  {
  ...
  public func moveTask(_ id: String, to destination: TaskMoveDestination, requestId: String? = nil)
    async throws -> Task
  {
  ...
  public func addProject(_ request: ProjectCreateRequest, requestId: String? = nil) async throws
    -> Project
  {
  ...
  @available(*, deprecated, message: "Use reminders.create(_:requestId:)")
  public func addReminder(_ request: AbsoluteReminderCreateRequest, requestId: String? = nil)
    async throws -> Reminder
  {
    try await reminders.create(request, requestId: requestId)
  }
  ...
  public func addLocationReminder(
    _ request: LocationReminderCreateRequest, requestId: String? = nil
  ) async throws -> Reminder {
  ...
  public func updateLocationReminder(
    _ id: String, _ request: LocationReminderUpdateRequest, requestId: String? = nil
  ) async throws -> Reminder {
  ...
  public func deleteReminder(_ id: String, requestId: String? = nil) async throws -> Bool {
    try await reminders.delete(id, requestId: requestId)
  }

  @available(*, deprecated, message: "Use reminders.deleteLocation(_:requestId:)")
  public func deleteLocationReminder(_ id: String, requestId: String? = nil) async throws -> Bool {
    try await reminders.deleteLocation(id, requestId: requestId)
  }

  @available(*, deprecated, message: "Use uploads.upload(_:requestId:)")
  public func uploadFile(_ request: UploadRequest, requestId: String? = nil) async throws
    -> Attachment
  {
  ...
  public func deleteUpload(fileURL: String, requestId: String? = nil) async throws -> Bool {
    try await uploads.delete(fileURL: fileURL, requestId: requestId)
  }

  @available(*, deprecated, message: "Use uploads.viewAttachment(url:)")
  public func viewAttachment(_ url: String) async throws -> TodoistFileResponse {
    try await uploads.viewAttachment(url: url)
  }

  @available(*, deprecated, message: "Use uploads.viewAttachment(comment:)")
  public func viewAttachment(_ comment: Comment) async throws -> TodoistFileResponse {
