...
public struct SyncRequest: Codable {
    ...
    public init(commands: [SyncCommand]? = nil, resourceTypes: [String]? = nil, syncToken: String? = nil) {
...
public let DAYS_OF_WEEK = ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"] as [String]
