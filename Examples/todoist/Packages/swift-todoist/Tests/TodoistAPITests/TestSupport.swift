  ...
  func perform(_ request: TodoistHTTPRequest) async throws -> TodoistHTTPResponse {
    ...
    guard !actions.isEmpty else {
      return TodoistHTTPResponse(
        statusCode: 500, statusText: "Missing Mock Action", headers: [:], data: Data())
    }
...
func jsonResponse(_ object: Any, statusCode: Int = 200, headers: [String: String] = [:]) throws
  -> TodoistHTTPResponse
{
...
func textResponse(_ text: String, statusCode: Int = 200, headers: [String: String] = [:])
  -> TodoistHTTPResponse
{
  TodoistHTTPResponse(
    statusCode: statusCode,
