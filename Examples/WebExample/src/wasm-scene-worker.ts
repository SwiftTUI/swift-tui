...
interface OutputWorkerMessage {
  type: "stdout" | "stderr";
  chunk: Uint8Array;
}

interface ExitWorkerMessage {
  type: "exit";
  code: number;
}

interface ErrorWorkerMessage {
  type: "error";
  message: string;
}

type WorkerMessage = StartWorkerMessage;
type WorkerResponse = OutputWorkerMessage | ExitWorkerMessage | ErrorWorkerMessage;
