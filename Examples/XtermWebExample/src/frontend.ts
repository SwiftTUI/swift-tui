...
const platformFrames = [
  ...
  {
    name: "Web",
    detail: "WASI build mounted in the browser via the xterm-based Web TUIGUI.",
    chrome: "platform-web",
    snapshot: webShotUrl
  },
  {
...
try {
  ...
  console.error("Failed to start XtermWebExample:", error);
}
      ...
      <main class="marketing-site">
        <section class="hero" id="top">
          <div class="hero-copy">
            ...
            <p class="hero-lede">
              Something went wrong while mounting the XtermWebExample. The terminal runtime did not start.
            </p>
...
async function bootstrap(): Promise<void> {
            ...
            <div class="terminal-shell">
              <div class="terminal-topline">
                <div class="terminal-topline-copy">
                  <span class="terminal-label">XtermWebExample</span>
                  <span class="terminal-caption">TerminalUI running through XtermWebTUIGUI</span>
                </div>
  ...
  if (!status || !scenes || !terminalFrame || !terminalHost || !resizeHandle) {
    throw new Error("failed to mount XtermWebExample");
  }
  ...
  try {
    return {
      controller: await createWebTUIApp({
        ...
        initialSceneId: "main",
        environment: {
          TUIGUI_APP_NAME: "Examples/XtermWebExample",
        },
