...
//
// See Vendor/UnixSignals/LICENSE.txt for license information
// See Vendor/UnixSignals/CONTRIBUTORS.txt for the list of SwiftServiceLifecycle project authors
//
...
public struct TerminalSignal: Hashable, Sendable, CustomStringConvertible {
  enum Wrapped {
    case sigabrt
    case sighup
    case sigill
...
extension TerminalSignal.Wrapped: Hashable {}
extension TerminalSignal.Wrapped: Sendable {}

extension TerminalSignal.Wrapped: CustomStringConvertible {
...
extension TerminalSignal.Wrapped {
  var rawValue: Int32 {
