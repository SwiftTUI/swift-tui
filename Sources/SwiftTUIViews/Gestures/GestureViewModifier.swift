...
@MainActor
public struct GestureAttachmentModifier<G: Gesture>: IterativePrimitiveViewModifier {
  let gesture: G
  ...
  package func makeResolveWork<Content: View>(
    ...
    return content.resolveWork(in: contentContext).map { completed in
      var node = completed
...
@MainActor
public struct ContentShapeModifier: IterativePrimitiveViewModifier, Sendable, Equatable {
...
@MainActor
public struct NamedCoordinateSpaceModifier: IterativePrimitiveViewModifier, Sendable, Equatable {
