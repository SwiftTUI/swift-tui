extension RuntimeConfiguration {
  ...
  public struct Builder: Sendable {
    ...
    public func color(_ value: ColorMode) -> Self {
      var copy = self; copy.configuration.color = value; return copy
    }

    public func glyphs(_ value: GlyphMode) -> Self {
      var copy = self; copy.configuration.glyphs = value; return copy
    }

    public func motion(_ value: MotionMode) -> Self {
      var copy = self; copy.configuration.motion = value; return copy
    }

    public func output(_ value: OutputMode) -> Self {
      var copy = self; copy.configuration.output = value; return copy
    }

    public func verbosity(_ value: Verbosity) -> Self {
      var copy = self; copy.configuration.verbosity = value; return copy
    }

    public func startIn(_ value: String?) -> Self {
      var copy = self; copy.configuration.startIn = value; return copy
    }

    public func debug(_ value: Bool) -> Self {
      var copy = self; copy.configuration.debug = value; return copy
    }

    public func noProgress(_ value: Bool) -> Self {
      var copy = self; copy.configuration.noProgress = value; return copy
    }

    public func linear(_ value: Bool) -> Self {
      var copy = self; copy.configuration.linear = value; return copy
    }
