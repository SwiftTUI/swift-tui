...
Platform integration and multi-scene orchestration are packaged separately in peer platform integration packages rather than in the root `SwiftTUI` library.
