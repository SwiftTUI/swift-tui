...
- <doc:Choosing-Modules-And-Platforms> — one dependency and one import for
  most apps, plus the product matrix when you need a narrower build.
- [Coming from SwiftUI](https://swifttui.sh/docs/documentation/swifttuiviews/coming-from-swiftui)
...
- [Authoring Views](https://swifttui.sh/docs/documentation/swifttuiviews/authoring-views)
  — containers, local state, focused controls, and modifiers around a
  body-driven tree.
- [State, Environment, and Focus](https://swifttui.sh/docs/documentation/swifttuiviews/state-environment-and-focus)
...
These guides ship in the `SwiftTUIRuntime` catalog.
