...
package enum FrameDiagnosticsTSVFormatting {
  ...
  package static func fields(
    ...
    return [
      ...
      String(record.mergedInvalidationRequestCount),
      formatMs(record.pacing.ewmaFrameCost),
      formatMs(record.pacing.gap),
      record.pacing.engaged ? "1" : "0",
      ...
      String(record.layoutBranching.builtinChildMeasureRequestsProbe),
      ...
      String(record.layoutBranching.customChildMeasureRequestsProbe),
