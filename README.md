...
![Status](https://img.shields.io/badge/status-0.8.7%20pre--release-DAA520)
...
```swift
.package(url: "https://github.com/SwiftTUI/swift-tui", .upToNextMinor(from: "0.8.7"))
