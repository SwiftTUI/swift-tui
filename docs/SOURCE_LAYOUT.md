...
- `Presentation/PresentationModifiers.swift` and `Presentation/CommandPalette.swift`: alerts, confirmation dialogs, sheets, toasts, command registration, and the canonical command-palette surface
