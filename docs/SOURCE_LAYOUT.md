...
- `Presentation/PresentationCoordinator.swift`, `Presentation/PresentationModifiers.swift`, and `Presentation/CommandPalette.swift`: shared presentation hoisting and arbitration, generic presentation primitives, built-in alert/confirmation-dialog/sheet/toast surfaces, command registration, and the canonical command-palette surface
