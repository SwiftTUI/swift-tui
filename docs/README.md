...
flowchart TD
    ...
    PROP["proposals/<br/>scoped gap proposals"]
...
Proposal documents are supporting artifacts for entries in
[VISION-GAP.md](VISION-GAP.md). They scope an individual unbuilt item; they do
not create an independent roadmap.
