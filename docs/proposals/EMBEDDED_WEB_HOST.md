...
| **CLI integration** | `myapp --web`, `--port`, `--bind`, and `--open` parse into `RuntimeConfiguration.web`; `SwiftTUIWebHostCLI` consumes web mode and `SwiftTUICLI` rejects it | `Platforms/Arguments/`, `Platforms/CLI/`, `Platforms/WebHost/` |
