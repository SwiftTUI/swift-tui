...
- `AndroidHostCellSizeSnapshot` — struct — 4 members
...
- `AndroidHostFrameSnapshot` — struct — 21 members
...
- `AndroidHostSceneHost` — class — 19 members
- `AndroidHostScrollRegionSnapshot` — struct — 6 members
