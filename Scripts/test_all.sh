...
# The readers live in Scripts/lib/runtime_shards.sh, shared with
# Scripts/release_soundness_lane.sh so the release lane's serialized shards
# are the same partition as this gate's.
